...
Now split per asset class ('stock' / 'forex') wherever it matters.
"""
...
bot_enabled = True  # manual global kill switch (overrides both asset classes)

max_trades_per_day = {"stock": 20, "forex": 20}
risk_percent = {"stock": 10, "forex": 5}
trades_today = {"stock": 0, "forex": 0}
